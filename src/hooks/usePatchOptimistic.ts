...
/**
 * Hook for PATCH requests with optimistic updates (React 19+)
 ...
 */
export function usePatchOptimistic<TData = any, TInput = any>(
  ...
  return useApiOptimistic<TData, TInput>(apiFunction, {
    ...options,
    cache: false, // PATCH requests shouldn't be cached
  });
}
